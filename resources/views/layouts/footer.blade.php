        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div class="flex items-center gap-5">
                    <div
                        class="flex-shrink-0 w-14 h-14 rounded-full bg-[#F7D558]/15 border border-[#F7D558]/30 flex items-center justify-center">
                        <span class="material-symbols-outlined text-[#F7D558] text-2xl"
                            style="font-variation-settings: 'FILL' 1;">
                            wifi
                        </span>
                    </div>
                    <div>
                        <p class="text-2xl font-extrabold text-white leading-none">752</p>
                        <p class="text-xs font-bold uppercase tracking-widest text-[#F7D558] mt-0.5">WiFi Points</p>
                        <p class="text-xs text-white/50 mt-0.5">City-wide public hotspots</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        <p class="text-2xl font-extrabold text-white leading-none">8</p>
                        <p class="text-xs font-bold uppercase tracking-widest text-[#F7D558] mt-0.5">Intra Networks</p>
                        <p class="text-xs text-white/50 mt-0.5">Government intranet nodes</p>
                    </div>
                </div>

                {{-- Stat 3: Connected Citizens --}}
                <div class="flex items-center gap-5">
                    <div
                        class="flex-shrink-0 w-14 h-14 rounded-full bg-[#F7D558]/15 border border-[#F7D558]/30 flex items-center justify-center">
                        <span class="material-symbols-outlined text-[#F7D558] text-2xl"
                    ...
                    <div>
                        <p class="text-2xl font-extrabold text-white leading-none">1.4M+</p>
                        <p class="text-xs font-bold uppercase tracking-widest text-[#F7D558] mt-0.5">Connected Citizens
                        </p>
                        <p class="text-xs text-white/50 mt-0.5">Residents with digital access</p>
                    </div>
                </div>
