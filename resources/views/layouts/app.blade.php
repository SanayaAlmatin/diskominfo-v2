...
<head>
    @php
        $siteTitle = trim($__env->yieldContent('title', 'Diskominfo Tangerang Selatan'));
        $siteDescription = trim($__env->yieldContent('meta_description', 'Portal resmi Dinas Komunikasi dan Informatika Kota Tangerang Selatan untuk informasi publik, layanan digital, data, dan infrastruktur teknologi informasi.'));
        $siteKeywords = trim($__env->yieldContent('meta_keywords', 'Diskominfo Tangerang Selatan, Kominfo Tangsel, Pemerintah Kota Tangerang Selatan, layanan digital, informasi publik, smart city, satu data'));
        $siteRobots = trim($__env->yieldContent('meta_robots', 'index, follow'));
        $siteUrl = url()->current();
