<header data-site-header
    class="w-full text-white relative z-50 bg-gradient-to-b from-[#2c6fb3] via-[#2564a6] to-[#1f5f9d] border-t border-[#3a7bc2] border-b border-[#184a86] shadow-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <button type="button"
            ...
            aria-controls="mobile-navigation" aria-expanded="false" aria-label="Buka menu navigasi"
            data-mobile-menu-button>
            <svg data-menu-icon-open xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <svg data-menu-icon-close xmlns="http://www.w3.org/2000/svg" class="hidden h-6 w-6" fill="none"
                viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Mobile Navigation -->
    <nav id="mobile-navigation" class="hidden lg:hidden border-t border-white/20 bg-white text-slate-800 shadow-xl"
        data-mobile-menu>
            ...
            <div class="space-y-2">
                <details class="group rounded-lg border border-slate-200 bg-white">
                    <summary
                        ...
                        Profil
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4 text-[#044FA0] transition group-open:rotate-180" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="border-t border-slate-100 py-2">
                        <a href="{{ route('profil.sekilas-diskominfo') }}" wire:navigate
                            class="block px-5 py-2.5 text-sm hover:bg-blue-50 hover:text-kominfo-blue {{ request()->routeIs('profil.sekilas-diskominfo') ? 'bg-blue-50 font-semibold text-kominfo-blue' : 'text-slate-600' }}">Sekilas
                            Diskominfo</a>
                        <a href="{{ route('profil.visi-misi') }}" wire:navigate
                            class="block px-5 py-2.5 text-sm hover:bg-blue-50 hover:text-kominfo-blue {{ request()->routeIs('profil.visi-misi') ? 'bg-blue-50 font-semibold text-kominfo-blue' : 'text-slate-600' }}">Visi
                            & Misi</a>
                        <a href="{{ route('profil.struktur-organisasi') }}" wire:navigate
                            class="block px-5 py-2.5 text-sm hover:bg-blue-50 hover:text-kominfo-blue {{ request()->routeIs('profil.struktur-organisasi') ? 'bg-blue-50 font-semibold text-kominfo-blue' : 'text-slate-600' }}">Struktur
                            Organisasi</a>
                    </div>
                </details>
                ...
                <details class="group rounded-lg border border-slate-200 bg-white">
                    ...
                    <div class="border-t border-slate-100 py-2">
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Bidang
                            E-Government</a>
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Bidang
                            IKP</a>
                ...
                <a href="#"
                    class="block rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 hover:bg-blue-50 hover:text-kominfo-blue">
                    Regulasi
                </a>
                ...
                <details class="group rounded-lg border border-slate-200 bg-white">
                    ...
                    <div class="border-t border-slate-100 py-2">
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Foto</a>
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Video</a>
                    </div>
                </details>
                ...
                <details class="group rounded-lg border border-slate-200 bg-white">
                    ...
                    <div class="border-t border-slate-100 py-2">
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Dokumen
                            Publik</a>
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-kominfo-blue">Laporan
                            Berkal</a>
                    </div>
                </details>
                ...
                <details class="group rounded-lg border border-[#F7D558]/70 bg-[#FFF7D8]">
                    <summary
                        class="flex cursor-pointer list-none items-center justify-between px-4 py-3 text-sm font-bold text-[#044FA0]">
                        Layanan Publik
                    ...
                    <div class="border-t border-[#F7D558]/60 py-2">
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-700 hover:bg-white hover:text-kominfo-blue">Pengaduan
                            Masyarakat</a>
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-700 hover:bg-white hover:text-kominfo-blue">Permohonan
                            Informasi</a>
                        <a href="#"
                            class="block px-5 py-2.5 text-sm text-slate-700 hover:bg-white hover:text-kominfo-blue">Satu
                            Data Tangsel</a>
                    </div>
                </details>
            </div>
    ...
    <script data-navigate-once>
        (() => {
            ...
            const initSiteHeader = () => {
                ...
                if (!header || !button || !menu || !openIcon || !closeIcon || header.dataset.siteHeaderReady ===
                    'true') {
                    return;
                }
