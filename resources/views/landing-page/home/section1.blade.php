    ...
    <section class="city-pattern relative overflow-hidden text-white">
        ...
        <div
            ...
            <div class="max-w-3xl">
                ...
                <h1
                    class="welcome-reveal welcome-delay-2 max-w-4xl text-3xl font-extrabold leading-tight tracking-normal text-white sm:text-4xl lg:text-5xl">
                ...
                <p class="welcome-reveal welcome-delay-3 mt-5 max-w-2xl text-base leading-8 text-blue-50 sm:text-lg">
                    Mengelola komunikasi publik dan infrastruktur teknologi informasi demi pelayanan masyarakat yang
                    lebih cerdas dan responsif.
                </p>

                <p class="welcome-reveal welcome-delay-4 mt-4 max-w-2xl text-sm leading-7 text-blue-100">
                    Diskominfo menjadi penghubung informasi resmi, tata kelola data, keamanan informasi, dan layanan
                    digital yang mendukung kota terkoneksi.
                </p>

                <div class="welcome-reveal welcome-delay-5 mt-7 flex flex-col gap-3 sm:flex-row">
                    <a href="#"
                        class="inline-flex items-center justify-center gap-2 rounded-lg bg-[#F7D558] px-5 py-3 text-sm font-bold text-[#044FA0] transition hover:bg-white">
                        Jelajahi Layanan
                    ...
                    <a href="#"
                        class="inline-flex items-center justify-center gap-2 rounded-lg border border-white/25 px-5 py-3 text-sm font-semibold text-white transition hover:border-white hover:bg-white/10">
                        Informasi Publik
                    </a>
                </div>
            </div>
            ...
            <div class="relative hidden lg:block">
                <div
                    class="welcome-network-panel ml-auto w-full max-w-md rounded-lg border border-white/20 bg-white/10 p-5">
                    <div class="flex items-center justify-between border-b border-white/20 pb-4">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#F7D558]">Kota Terkoneksi
                            </p>
                    ...
                    <div class="mt-5 space-y-3">
                        <div class="flex items-center gap-3 rounded-lg border border-white/20 p-3">
                            <span
                                class="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-[#F7D558]">
                        ...
                        <div class="flex items-center gap-3 rounded-lg border border-white/20 p-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-100">Informasi resmi yang jelas, cepat, dan terverifikasi.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="bg-[#F5F8FC] px-4 py-10 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <a href="#"
                    class="service-card service-mark rounded-lg border border-slate-200 bg-white p-5 transition hover:-translate-y-1 hover:border-[#044FA0] hover:shadow-lg">
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">Publikasi berita, agenda, dan dokumen resmi
                        pemerintah kota.</p>
                </a>
                ...
                <a href="#"
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">Penguatan data sektoral untuk perencanaan dan
                        evaluasi kebijakan.</p>
                </a>
                ...
                <a href="#"
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">Dukungan persandian dan perlindungan sistem
                        elektronik pemerintah.</p>
                </a>
                ...
                <a href="#"
                    ...
                    <p class="mt-3 text-sm leading-7 text-slate-600">Integrasi infrastruktur digital untuk pelayanan
                        yang responsif.</p>
                </a>
            </div>
        </div>
