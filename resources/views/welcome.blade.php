    ...
    <main class="flex-1">
        <section class="city-pattern relative overflow-hidden text-white">
            ...
            <div class="relative mx-auto grid min-h-[50vh] max-w-7xl items-center gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[1.08fr_.92fr] lg:px-8 lg:py-12">
                <div class="max-w-3xl">
                    <div class="mb-5 inline-flex items-center gap-3 rounded-lg border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white">
                ...
                <div class="relative hidden lg:block">
                    <div class="ml-auto w-full max-w-md rounded-lg border border-white/20 bg-white/10 p-5">
                        ...
                        <div class="mt-5 grid grid-cols-2 gap-3">
                            <div class="rounded-lg bg-white p-4 text-[#044FA0]">
                            ...
                            <div class="rounded-lg bg-[#F7D558] p-4 text-[#044FA0]">
        ...
        <section class="bg-[#F5F8FC] px-4 py-10 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-7xl">
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <a href="#" class="service-mark rounded-lg border border-slate-200 bg-white p-5 transition hover:-translate-y-1 hover:border-[#044FA0] hover:shadow-lg">
