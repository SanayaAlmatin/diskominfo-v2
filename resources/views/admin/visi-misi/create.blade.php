            ...
            <form method="POST" action="{{ route('admin.visi-misi.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="konten" rows="5"
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('konten') border-red-400 @enderror"
