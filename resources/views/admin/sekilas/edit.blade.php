        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.sekilas.update', $sekilas) }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <textarea name="content" rows="8" class="tinymce-editor w-full @error('content') border-red-400 @enderror">{{ old('content', $sekilas->content) }}</textarea>
                    @error('content')
                ...
                <div>
                    ...
                    @if ($sekilas->gambar)
                        <div class="flex items-center gap-3 p-3 mb-3 bg-gray-50 rounded-xl border border-gray-100">
                            <img src="{{ Storage::url($sekilas->gambar) }}"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-400 truncate mt-0.5">{{ basename($sekilas->gambar) }}</p>
                            </div>
