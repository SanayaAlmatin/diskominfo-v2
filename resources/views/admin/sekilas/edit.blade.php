...
@section('title', 'Edit Sekilas Diskominfo')
@section('page-title', 'Edit Sekilas Diskominfo')
...
@section('content')
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-5">
            ...
            <h2 class="text-lg font-bold text-gray-800">Edit Sekilas Diskominfo</h2>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.sekilas.update', $sekilas) }}" enctype="multipart/form-data"
                class="space-y-5">
                @csrf @method('PUT')
                ...
                <div>
                    ...
                    <textarea name="content" rows="8"
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('content') border-red-400 @enderror">{{ old('content', $sekilas->content) }}</textarea>
                    @error('content')
                ...
                <div>
                    ...
                    @if ($sekilas->gambar)
                        <div class="mb-3">
                            <img src="{{ Storage::url($sekilas->gambar) }}" class="h-32 w-auto rounded-lg object-cover"
                                alt="">
