...
@section('page-title', 'Edit Banner & Program')
...
@section('content')
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-5">
            ...
            <h2 class="text-lg font-bold text-gray-800">Edit Banner</h2>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.program-vacancy.update', $programVacancy) }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $programVacancy->description) }}</textarea>
                    @error('description')
                ...
                <div>
                    ...
                    @if ($programVacancy->image)
                        <div class="mb-3">
                            <img src="{{ Storage::url($programVacancy->image) }}"
                                class="h-32 w-auto rounded-lg object-cover" alt="">
                ...
                <div>
                    ...
                    <input type="url" name="link_url" value="{{ old('link_url', $programVacancy->link_url) }}"
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_active" value="1" id="is_active"
                        {{ old('is_active', $programVacancy->is_active) ? 'checked' : '' }}
