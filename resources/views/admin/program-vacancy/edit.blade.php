        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.program-vacancy.update', $programVacancy) }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" class="tinymce-editor-simple w-full">{{ old('description', $programVacancy->description) }}</textarea>
                    @error('description')
                    ...
                    @if ($programVacancy->image)
                        <div class="flex items-center gap-3 p-3 mb-3 bg-gray-50 rounded-xl border border-gray-100">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-400 truncate mt-0.5">{{ basename($programVacancy->image) }}</p>
                            </div>
