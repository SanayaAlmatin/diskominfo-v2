            ...
            <form method="POST" action="{{ route('admin.program-vacancy.store') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="tinymce-editor-simple w-full @error('description') border-red-400 @enderror"
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <input type="file" x-ref="fileInput" name="image" accept="image/*" required class="hidden"
                        ...
                        <div x-show="!previewUrl" @click="$refs.fileInput.click()"
                            ...
                            <p class="text-xs text-gray-400 mt-1">JPG, PNG, WebP &middot; Maks. 2MB &middot; Rasio 16:5</p>
                        </div>
                    ...
                    <p class="mt-1.5 text-xs text-gray-400">Format: JPG, PNG, WebP. Maks. 2MB. Disarankan rasio 16:5.</p>
                    @error('image')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
