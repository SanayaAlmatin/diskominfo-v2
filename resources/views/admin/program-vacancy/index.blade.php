                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($items as $item)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                @if ($item->image)
                                    <img src="{{ Storage::url($item->image) }}" class="w-24 h-14 object-cover rounded-lg"
                                        alt="">
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-12 text-center text-gray-400 text-sm">Belum ada banner.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
