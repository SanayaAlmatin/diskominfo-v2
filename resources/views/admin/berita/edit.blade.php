            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="subtitle" value="{{ old('subtitle', $berita->subtitle) }}"
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content-editor" rows="15"
                                    class="tinymce-editor w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm @error('content') border-red-400 @enderror">{{ old('content', $berita->content) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="excerpt" id="excerpt-field" rows="3"
                                    ...
                                    placeholder="Ringkasan singkat artikel (akan dibuat otomatis jika kosong)">{{ old('excerpt', $berita->excerpt) }}</textarea>
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-5">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Upload Gambar Baru <span class="text-xs font-normal text-gray-400">(Biarkan kosong jika tidak ingin mengubah)</span></label>
                                
                                <div x-data="{
                                        fileName: '',
                                        previewUrl: '{{ $berita->image_url }}',
                                        dragging: false,
                                        handleFile(e) {
                                        ...
                                        clear() {
                                            this.fileName = '';
                                            this.previewUrl = '{{ $berita->image_url }}'; // Revert to original
                                    ...
                                    <div x-show="previewUrl" class="p-4" style="display:none;">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <p class="text-xs font-semibold text-gray-800" x-text="fileName ? fileName : 'Gambar Saat Ini'"></p>
                                                <button type="button" @click="$refs.fileInput.click()" class="text-xs text-blue-600 hover:text-blue-800 font-medium ml-2">Ganti Gambar</button>
                                                <button type="button" x-show="fileName" @click="clear()" class="text-xs text-red-500 hover:text-red-700 font-medium ml-2">Batal Ubah</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <p class="mt-1.5 text-xs text-gray-400"><svg class="w-3.5 h-3.5 inline mr-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> Upload gambar baru. Format: JPG, JPEG, PNG (max 2MB).</p>
                            ...
                            <div>
                                ...
                                <input type="text" name="image_caption" value="{{ old('image_caption', $berita->image_caption) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="datetime-local" name="published_at" value="{{ old('published_at', $berita->published_at ? $berita->published_at->format('Y-m-d\TH:i') : '') }}"
                            ...
                            <div class="pt-2">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <input type="checkbox" name="is_headline" value="1" {{ old('is_headline', $berita->is_headline) ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div>
                            ...
                            @php
                                $selectedTags = is_array(old('tags')) ? old('tags') : $berita->tags->pluck('id')->toArray();
                            @endphp
                            <select name="tags[]" id="tags-select" multiple="multiple" class="w-full">
                                @foreach($tags as $tag)
                                    <option value="{{ $tag->id }}" {{ in_array($tag->id, $selectedTags) ? 'selected' : '' }}>{{ $tag->n_tag }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="meta_title" value="{{ old('meta_title', $berita->meta_title) }}"
                            ...
                            <div>
                                ...
                                <textarea name="meta_description" rows="3"
                                    ...
                                    placeholder="Meta description untuk SEO">{{ old('meta_description', $berita->meta_description) }}</textarea>
