...
@section('title', 'Edit Portal Terkait')
@section('page-title', 'Konten Footer — Edit Portal')
...
@section('content')
    <div class="max-w-xl space-y-4">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-lg font-bold text-gray-800">Edit Portal Terkait</h2>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.footer.portals.update', $portal) }}">
                @csrf @method('PUT')
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="label" value="{{ old('label', $portal->label) }}"
                            placeholder="Dinkes Tangsel"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">URL <span
                                class="text-red-500">*</span></label>
                        <input type="url" name="url" value="{{ old('url', $portal->url) }}"
                            placeholder="https://..."
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order', $portal->sort_order) }}"
                            min="0"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" name="is_active" id="is_active" value="1"
                            {{ old('is_active', $portal->is_active) ? 'checked' : '' }}
