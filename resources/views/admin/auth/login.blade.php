...
<head>
    ...
    <title>Login — CMS Diskominfo Tangsel</title>
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="px-8 py-8">
                ...
                <div class="mt-4 relative">
                    ...
                    <div class="relative flex justify-center text-xs text-gray-500 bg-white px-3">
                        atau
                    </div>
                </div>

                <a href="{{ route('admin.auth.google') }}"
                    class="mt-4 flex items-center justify-center gap-3 w-full py-3 px-4 rounded-lg border border-gray-300
                          text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 transition-all hover:-translate-y-0.5 shadow-sm">
                ...
                <p class="mt-6 text-center text-xs text-gray-400">
                    Hanya akun yang telah terdaftar yang dapat mengakses CMS ini.
                </p>
            </div>
        </div>
    </div>
